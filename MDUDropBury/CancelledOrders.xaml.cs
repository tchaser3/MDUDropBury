 ...
 * Author:          Terry Holmes
 * 
 * Description:     This form will show the cancelled orders*/
...
namespace MDUDropBury
{
    ...
    /// </summary>
    public partial class CancelledOrders : Window
    {
        ...
        private void Window_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            {
                TheEventLogClass.InsertEventLogEntry(DateTime.Now, "MDU Drop Bury // Cancelled Orders // Window Loaded " + Ex.Message);

                TheMessagesClass.ErrorMessage(Ex.ToString());
            }
        }

        private void cboWorkType_SelectionChanged(object sender, System.Windows.Controls.SelectionChangedEventArgs e)
        {
            //setting local variables
            ...
            {
                TheEventLogClass.InsertEventLogEntry(DateTime.Now, "MDU Drop Bury // Cancelled Orders // cbo Work Type Changed " + Ex.Message);
        ...
        private bool  LoadOrderStatusDataSet(int intWorkOrderID, string strWorkOrderNumber, string strAccountNumber, string strAddress, string strPhoneNumber, string strCity, DateTime datReceivedDate, string strStatus, string strZone)
        {
            ...
            {
                TheEventLogClass.InsertEventLogEntry(DateTime.Now, "MDU Drop Bury // Cancelled Orders // Load Order Status Data Set " + Ex.Message);
        ...
        private void cboReportType_SelectionChanged(object sender, System.Windows.Controls.SelectionChangedEventArgs e)
        {
        ...
        private void cboZone_SelectionChanged(object sender, System.Windows.Controls.SelectionChangedEventArgs e)
        {
            //setting local variables
            int intSelectedIndex;
            int intCounter;
            ...
            {
                TheEventLogClass.InsertEventLogEntry(DateTime.Now, "MDU Drop Bury // Cancelled Orders // cbo Zone Change" + Ex.Message);
        ...
        private void btnFind_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                TheEventLogClass.InsertEventLogEntry(DateTime.Now, "MDU Drop Bury // Cancelled Orders // Find Button");

                TheMessagesClass.ErrorMessage(Ex.ToString());
            }
        }
        private void ViewTextControls()
        {
            txtStartDate.Visibility = Visibility.Visible;
            lblStartDate.Visibility = Visibility.Visible;
            lblStartDate.Content = "Enter Info";
        }

        private void dgrResults_SelectionChanged(object sender, System.Windows.Controls.SelectionChangedEventArgs e)
        {
            ...
            {
                TheEventLogClass.InsertEventLogEntry(DateTime.Now, "MDU Drop Bury // Cancelled Orders // Work Selection Change " + Ex.Message);
